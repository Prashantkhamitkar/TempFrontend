...
const TicketModi = ({ setTicketData, reset, ticketnumber }) => {
              ...
              <Row>
                <Col lg="6">
                  <div className="mb-3">
                    ...
                    <strong
                      className="badge badge-soft-success ms-3"
                  ...
                  <Row>
                    <Col lg="6">
                      <div className="mb-3">
                        ...
                        <span className="badge bg-success pt-1 pb-1 ps-2 pe-2 ms-3 mb-0">
                          YES
                        </span>
                      </div>
                    </Col>
                    <Col lg="6">
                      <div className="mb-3">
                        ...
                        <span className="badge bg-warning pt-1 pb-1 ps-2 pe-2 ms-3 mb-0">
                          SYS
                        </span>
                      </div>
                    </Col>
